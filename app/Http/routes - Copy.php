...
Route::group(['prefix' => LaravelLocalization::getCurrentLocale(), 'before' => ['localization', 'before']], function () {
    ...
    // article
    Route::get('/article', ['as' => 'dashboard.article', 'uses' => 'ArticleController@index']);
    Route::get('/article/{slug}', ['as' => 'dashboard.article.show', 'uses' => 'ArticleController@show']);

    // news
    Route::get('/news', ['as' => 'dashboard.news', 'uses' => 'NewsController@index']);
    Route::get('/news/{slug}', ['as' => 'dashboard.news.show', 'uses' => 'NewsController@show']);
    ...
    // video
    Route::get('/video', ['as' => 'dashboard.video', 'uses' => 'VideoController@index']);
    Route::get('/video/{slug}', ['as' => 'dashboard.video.show', 'uses' => 'VideoController@show']);

    // projects
    Route::get('/project', ['as' => 'dashboard.project', 'uses' => 'ProjectController@index']);
    Route::get('/project/{slug}', ['as' => 'dashboard.project.show', 'uses' => 'ProjectController@show']);

    // contact
    Route::get('/contact', ['as' => 'dashboard.contact', 'uses' => 'FormPostController@getContact']);

    // faq
    Route::get('/faq', ['as' => 'dashboard.faq', 'uses' => 'FaqController@show']);
...
Route::group(['prefix' => LaravelLocalization::getCurrentLocale()], function () {
    Route::group(['prefix'          => '/admin',
        ...
        Route::resource('slider', 'SliderController');
                           Route::get('slider/{id}/delete', ['as'        => 'admin.slider.delete',
                                               'uses' => 'SliderController@confirmDestroy', ])->where('id', '[0-9]+');

        // file upload slider
        Route::post('/slider/upload/{id}', ['as'         => 'admin.slider.upload.image',
                                                 'uses'  => 'SliderController@upload', ])->where('id', '[0-9]+');
                           Route::post('/slider-delete-image', ['as'        => 'admin.slider.delete.image',
                                                  'uses' => 'SliderController@deleteImage', ]);

        // menu-managment
        Route::resource('menu', 'MenuController');
                           Route::post('menu/save', ['as' => 'admin.menu.save', 'uses' => 'MenuController@save']);
                           Route::get('menu/{id}/delete', ['as'                 => 'admin.menu.delete',
                                             'uses'          => 'MenuController@confirmDestroy', ])->where('id', '[0-9]+');
                           Route::post('menu/{id}/toggle-publish', ['as'        => 'admin.menu.toggle-publish',
        ...
        // language
        Route::get('language/set-locale/{language}', ['as'        => 'admin.language.set',
                                                           'uses' => 'LanguageController@setLocale', ]);
                       });
});

Route::post('/contact', ['as'        => 'dashboard.contact.post',
                              'uses' => 'FormPostController@postContact', ], ['before' => 'csrf']);
...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::get('admin/forgot-password', ['as'        => 'admin.forgot.password',
                                              'uses' => 'AuthController@getForgotPassword', ]);
    Route::post('admin/forgot-password', ['as'        => 'admin.forgot.password.post',
                                               'uses' => 'AuthController@postForgotPassword', ]);

    Route::get('admin/{id}/reset/{code}', ['as'        => 'admin.reset.password',
                                                'uses' => 'AuthController@getResetPassword', ])->where('id', '[0-9]+');
    Route::post('admin/reset-password', ['as'          => 'admin.reset.password.post',
